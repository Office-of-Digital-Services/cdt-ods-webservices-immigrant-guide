var MultiLanguageCode = MultiLanguageCode || {};

MultiLanguageCode.createNameSpace = function (namespace) {

    //get the namespace string and split it
    var namespaceArr = namespace.split('.');
    var parent = MultiLanguageCode;

    // excluding the parent
    if (namespaceArr[0] === 'MultiLanguageCode') {
...
MultiLanguageCode.createNameSpace("MultiLanguageCode.Cookies");

MultiLanguageCode.Cookies.getCookie = function (ck_name) {
...
MultiLanguageCode.Cookies.setCookie = function (ck_name, value, exdays) {
    var exdate = new Date();
